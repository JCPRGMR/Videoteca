...
<body class="h100vh w100p m0 overflow-auto">
    <main class="f-col h100p color7">
        <div class="br10 w100p h100p color8 overflow-auto border-box">
            ...
            <div class="color1 m10 overflow-auto">
                <table class="color7 w100p h100p collapse" border="1">
                    <thead class="">
                        <th class="center white p10">&Aacute;REA</th>
                        <th class="center white p10">TIPO</th>
                        <th class="center white p10">DESCRIPCI&Oacute;N DEL EVENTO</th>
                        <th class="center white p10">DETALLE DE CONTENIDO</th>
                    ...
                    <tbody id="body">
                        <?php foreach(Videos::Mostrar(1) as $item):?>
                            <tr class="white">
                                ...
                                <td class="color8 p10 center"><?= $item->detalles ?></td>
